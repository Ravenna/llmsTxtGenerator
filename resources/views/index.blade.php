...
@section('content')
  <div class="card card-lg p-0 content">
    <header class="py-6 px-8 border-b">
      ...
      <p>Automatically create and maintain a custom <em><b>llms.txt</b></em> file, for any and all your collections and content to allow the new proposed LLMs standard to interface your website with AI.</p>
    </header>
    <div class="flex flex-wrap p-4">
      <div class="w-full lg:w-1/2 p-4 flex items-start hover:bg-gray-200 rounded-md group">
      ...
      <div class="w-full lg:w-1/2 p-4 flex items-start hover:bg-gray-200 rounded-md group">
        ...
        <a href="{{ cp_route('llms-generator.generate') }}" class="mr-2 text-grey-80">
        ...
        <div class="flex-1">
          <h3 class="mb-1"><a href="{{ cp_route('llms-generator.generate') }}" class="text-blue">Generate</a></h3>
